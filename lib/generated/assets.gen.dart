...
class $AssetsSvgsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [menu];
}

class Assets {
  const Assets._();

  static const String configDevelopment = 'assets/config_development.json';
  ...
  /// List of all assets
  static List<String> get values => [configDevelopment, configProduction];
}
