...
import 'package:daily_water_tracker/features/auth/screens/complete_password_reset_screen.dart';
...
const String completePasswordResetRoute = '/login/complete-password-reset';
...
final goRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: completePasswordResetRoute,
      name: 'CompletePasswordReset',
      builder: (context, state) {
        final oobCode = state.uri.queryParameters['oobCode'] ?? '';
        return CompletePasswordResetScreen(oobCode: oobCode);
      },
    ),
    GoRoute(
      path: signUpRoute,
